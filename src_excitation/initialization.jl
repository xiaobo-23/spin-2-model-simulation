# 4/28/2025
# Set up the Hamiltonian for the spin-1 Heisenberg chain
...
"""
    ...
    Build the site indices and a random product-of-`|+1⟩`-like MPS as DMRG's
    starting point. Logs the initial ⟨Sᶻ⟩ profile.
"""

function initial_state(params::SimulationParameters; linkdims::Int = 10)
    Random.seed!(params.seed)
    sites = siteinds("S=1", params.N)
    ψ₀    = random_mps(sites, "Up"; linkdims = linkdims)
